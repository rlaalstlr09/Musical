...
<body>
	<div class="container">
		...
		<form id="smsForm" action="findPwSmsCheck" method="post" >
			<div class="form-group">
				<label><input type="checkbox" name="method" value="sms" id="box" class="box1">
				<span class="text">문자 인증</span></label>
				<input type="hidden" name="customer_id" id="customer_id" class="cd1"
					placeholder="아이디">
		...
		<form id="findForm" action="findPwCheck" method="post">
			<div class="form-group">
				...
				<input type="hidden" name="customer_id" id="customer_id" class="cd2"
					placeholder="아이디">
		...
		<input type="button" id="pw-find" onclick="submitForm()" value="비밀번호 찾기">
	</div>
</body>
</html>